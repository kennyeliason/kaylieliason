...
const quizQuestions: QuizQuestion[] = [
  ...
  {
    category: 'Density Lab',
    question: 'Which liquid from the worksheet is most dense?',
  ...
  {
    category: 'Density Lab',
    question: 'Which liquid from the worksheet is least dense?',
  ...
  {
    category: 'Density Lab',
    question: 'If blue, green, and yellow are poured into one test tube, which liquid should be on the bottom?',
  ...
  {
    category: 'Density Lab',
    question: 'What is the correct top-to-bottom layer order for the worksheet liquids?',
