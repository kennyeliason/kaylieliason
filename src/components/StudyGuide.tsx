...
const questions = [
  ...
  { id: 13232, unit: '🌎Unit 13', topic: 'Scientists', q: 'Lamarck can up with the idea that…', a: 'Traits acquired during life are inherited', wrong: ['Population growth is limited by resources', 'Earth changes slowly over time', 'Natural selection explains evolution'] },
  { id: 13233, unit: '🌎Unit 13', topic: 'Scientists', q: 'Wallace can up with the idea that…', a: 'Natural selection explains evolution', wrong: ['Earth changes slowly over time', 'Traits acquired during life are inherited', 'Use and disuse never affects organisms'] },
