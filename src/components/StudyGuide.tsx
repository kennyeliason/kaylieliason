...
const questions = [
  ...
  // Unit 12 - exact 49 questions from this morning
  ...
  { id: 1211, unit: 'Unit 12', topic: 'DNA Structure', q: 'Which of the following statements is NOT consistent with the structure of DNA?', a: 'Strands are held together by unbreakable chemical bonds', wrong: ['Adenine pairs with thymine and cytosine pairs with guanine', 'Strands are twisted into a double helix', 'DNA is composed of two strands made up of nucleotides'] },
  { id: 1212, unit: 'Unit 12', topic: 'Protein Structure', q: 'Which of the following best describes quaternary structure?', a: 'Multiple polypeptide chains forming one protein', wrong: ['Local folding into helices and sheets', 'A chain of amino acids', 'Folding caused by R-group interactions'] },
  { id: 1213, unit: 'Unit 12', topic: 'Transcription', q: 'A chemical disrupts RNA polymerase activity in a cell. Which process is directly affected?', a: 'Transcription', wrong: ['Protein folding', 'DNA replication', 'Translation'] },
  { id: 1214, unit: 'Unit 12', topic: 'DNA Replication', q: 'UV radiation causes damage that prevents DNA from being copied correctly. Which process is most directly impacted first?', a: 'DNA replication', wrong: ['Transcription', 'Translation', 'Protein folding'] },
  { id: 1215, unit: 'Unit 12', topic: 'Protein Structure', q: 'Match each scenario to the level of protein structure it BEST represents.', a: 'A. Hemoglobin is made of four polypeptide chains; B. Hydrogen bonds form coils and sheets; C. A mutation changes the order of amino acids in a protein; D. Interactions between R groups create a 3D shape', wrong: [] },
  { id: 1216, unit: 'Unit 12', topic: 'Protein Structure', q: 'Proteins are a', a: 'Molecule', wrong: ['Specialized cell', 'Reaction', 'Chemical'] },
  { id: 1217, unit: 'Unit 12', topic: 'DNA Function', q: 'What is the function of DNA in cells?', a: 'It stores the information that directs the ribosomes in protein synthesis', wrong: ['It is a storage area for unused nucleotides', 'It serves as a filler material to keep the nucleus from collapsing', 'It is the storage area for carbohydrates and other macromolecules'] },
  { id: 1218, unit: 'Unit 12', topic: 'DNA Replication', q: 'Each new strand of DNA made in replication has how much of the original strand within it?', a: '50%', wrong: ['25%', '0%', '100%'] },
  { id: 1219, unit: 'Unit 12', topic: 'Genetics', q: 'A segment of DNA which codes for a specific protein is called a', a: 'Gene', wrong: ['Amino acid', 'tRNA', 'Chromosome'] },
  { id: 1220, unit: 'Unit 12', topic: 'DNA Replication', q: 'The process by which DNA makes a copy of itself is called:', a: 'Replication', wrong: ['Translation', 'Synthesis', 'Transcription'] },
  { id: 1221, unit: 'Unit 12', topic: 'DNA Replication', q: 'DNA replication occurs in the', a: 'Nucleus', wrong: ['Cytoplasm', 'Ribosome', 'Mitochondria'] },
  { id: 1222, unit: 'Unit 12', topic: 'Translation', q: 'Protein synthesis (translation) occurs in the', a: 'Ribosome', wrong: ['Cytoplasm', 'Mitochondria', 'Nucleus'] },
  { id: 1223, unit: 'Unit 12', topic: 'Mutations', q: 'A scientist observes that a protein is shorter than normal because translation stopped early. What most likely caused this?', a: 'Nonsense mutation', wrong: ['Missense mutation', 'Frameshift mutation', 'Silent mutation'] },
  { id: 1224, unit: 'Unit 12', topic: 'DNA Structure', q: 'The discovery of the structure of DNA was…', a: 'Watson, Crick, Franklin and Wilkins', wrong: ['Berkely, Fry, Wilkins and Franklin', 'Lamarke, Darwin, and Rosalind Franklin'] },
  { id: 1225, unit: 'Unit 12', topic: 'Protein Structure', q: 'Which level of protein structure is directly determined by the DNA sequence?', a: 'Primary', wrong: ['Tertiary', 'Secondary', 'Quaternary'] },
  { id: 1226, unit: 'Unit 12', topic: 'Mutations', q: 'A mutation changes a DNA base, but the resulting protein is identical to the original. What is the MOST likely explanation?', a: 'The codon still coded for the same amino acid', wrong: ['The gene was not transcribed', 'The mutation caused a frameshift', 'A stop codon was introduced'] },
  { id: 1227, unit: 'Unit 12', topic: 'Translation', q: 'A ribosome reads mRNA, but no tRNA molecules can deliver amino acids. What will happen?', a: 'The protein will not be assembled', wrong: ['DNA will be degraded', 'Replication will speed up', 'mRNA will not be produced'] },
  { id: 1228, unit: 'Unit 12', topic: 'DNA Replication', q: 'A drug blocks DNA replication, but transcription and translation continue temporarily. What will happen over time?', a: 'Cells cannot divide and will eventually die', wrong: ['Ribosomes will stop functioning immediately', 'Protein production increases permanently', 'Mutations will stop occurring'] },
  { id: 1229, unit: 'Unit 12', topic: 'Translation', q: 'Arrange the steps from a gene on DNA to a protein.', a: 'DNA → mRNA → Ribosome → tRNA → Protein', wrong: ['DNA → protein → mRNA → Ribosome', 'mRNA → DNA → tRNA → Protein', 'Protein → tRNA → Ribosome → DNA'] },
  { id: 1230, unit: 'Unit 12', topic: 'DNA Structure', q: 'The sugar found in DNA is:', a: 'Deoxyribose', wrong: ['Glucose', 'Equal', 'Ribose'] },
  { id: 1231, unit: 'Unit 12', topic: 'Base Pairing', q: 'If a DNA strand had the sequence TACGCATAT, the complementary strand would be:', a: 'ATGCGTATA', wrong: ['TACGCATAT', 'ATATGCGTA', 'AUGCGUAUA', 'None of the above'] },
  { id: 1232, unit: 'Unit 12', topic: 'DNA Replication', q: 'Match the terms:', a: 'A. Producing two identical DNA copies; B. Process where proteins are made from RNA; C. Process where RNA is made from DNA', wrong: [] },
  { id: 1233, unit: 'Unit 12', topic: 'DNA Function', q: 'DNA is called the “blueprint of life” because:', a: 'It contains the plans for building an organism', wrong: ['It is like a fingerprint', 'It can relay messages to other molecules', 'It has a blue color'] },
  { id: 1234, unit: 'Unit 12', topic: 'Transcription', q: 'What happens in transcription?', a: 'Messenger RNA is made from DNA', wrong: ['Copies of DNA are made', 'Transfer RNA is made from messenger RNA', 'The cell uses information from messenger RNA to make proteins'] },
  { id: 1235, unit: 'Unit 12', topic: 'Genetics', q: 'A cell has the gene for a protein, but the protein is never produced. What is the most likely explanation?', a: 'The gene is not being expressed', wrong: ['The DNA is missing', 'The ribosomes are too fast', 'The codons are incorrect'] },
  { id: 1236, unit: 'Unit 12', topic: 'Mutations', q: 'Sickle cell anemia is caused by a single base substitution that changes one amino acid in hemoglobin. What type of mutation is this?', a: 'Missense mutation', wrong: ['Silent mutation', 'Frameshift mutation', 'Nonsense mutation'] },
  { id: 1237, unit: 'Unit 12', topic: 'Base Pairing', q: 'Which is true?', a: 'Guanine bonds with cytosine', wrong: ['All of the above', 'Guanine bonds with thymine', 'Adenine bonds with cytosine'] },
  { id: 1238, unit: 'Unit 12', topic: 'Mutations', q: 'A mutation changes one amino acid in a protein, altering its function. What type of mutation is this?', a: 'Missense', wrong: ['Nonsense', 'Frameshift', 'Silent'] },
  { id: 1239, unit: 'Unit 12', topic: 'Protein Structure', q: '(Hot spot)', a: 'Tertiary structure', wrong: ['Primary structure', 'Secondary structure', 'Quaternary structure'] },
  { id: 1240, unit: 'Unit 12', topic: 'DNA Structure', q: 'The DNA molecule is held together by:', a: 'Hydrogen bonds', wrong: ['Glucose', 'Magnetism', 'Glue'] },
  { id: 1241, unit: 'Unit 12', topic: 'DNA Function', q: 'Why is DNA important?', a: 'It directs the production of proteins within organisms', wrong: ['It is the major component of cytoplasm', 'It directly increases the solubility of nutrients', 'It is a structural component of cell membranes'] },
  { id: 1242, unit: 'Unit 12', topic: 'Mutations', q: 'A mutation deletes one nucleotide in the middle of a gene. What is the most likely result?', a: 'The entire reading frame shifts', wrong: ['The protein becomes longer', 'Only one amino acid is affected', 'The gene becomes silent'] },
  { id: 1243, unit: 'Unit 12', topic: 'Translation', q: 'Using the genetic code chart, determine the amino acids that correspond to the given mRNA codons:', a: 'A. C G C; B. U A U; C. U G A; D. A C U', wrong: [] },
  { id: 1244, unit: 'Unit 12', topic: 'Genetics', q: 'A gene is:', a: 'A segment of DNA that codes for a protein', wrong: ['A molecule within DNA', 'A set of homologous chromosomes', 'A type of pants'] },
  { id: 1245, unit: 'Unit 12', topic: 'DNA Structure', q: 'Which base is never found in DNA?', a: 'Uracil', wrong: ['Adenine', 'Cytosine', 'Thymine', 'Guanine'] },
  { id: 1246, unit: 'Unit 12', topic: 'Base Pairing', q: 'Unlike DNA, RNA contains:', a: 'Uracil', wrong: ['Phosphate groups', 'Thymine', 'Adenine'] },
  { id: 1247, unit: 'Unit 12', topic: 'Translation', q: 'Why can one amino acid be specified by multiple codons?', a: 'There are 64 codons but only 20 amino acids', wrong: ['Some codons do not specify an amino acid', 'Some codons have the same sequence', 'AUG codes for methionine'] },
  ...
  { id: 1401, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'Which best defines biotechnology?', a: 'Using living things or their parts to solve problems or make useful products', wrong: ['Studying only stars and planets', 'Using rocks to generate electricity', 'Naming every species on Earth'] },
  { id: 1402, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'Biotechnology is the use of ____ to ____.', a: 'living organisms; make useful products or solve problems', wrong: ['minerals; build planets', 'heat; destroy all cells', 'machines only; replace ecosystems'] },
  { id: 1403, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'Biotechnology often involves using ____ like ____ and ____ to benefit ____.', a: 'organisms; bacteria; yeast; humans', wrong: ['metals; iron; copper; volcanoes', 'clouds; rain; snow; deserts', 'rocks; granite; marble; rivers'] },
  { id: 1404, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'Which is a real-world example of biotechnology?', a: 'Using bacteria to make insulin for people with diabetes', wrong: ['Measuring the distance to the moon', 'Sorting rocks by color', 'Watching clouds move across the sky'] },
  { id: 1405, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'The use of ____ to produce ____ is an example of early biotechnology from the ____ era.', a: 'yeast; bread; ancient', wrong: ['plastic; gasoline; digital', 'sand; glass; medieval', 'robots; batteries; modern'] },
  { id: 1406, unit: '🔭Unit 14', topic: 'Modern Biotechnology', q: 'Most modern biotechnology depends on the ability to ____ DNA and ____ strands of DNA.', a: 'cut; combine', wrong: ['burn; erase', 'weigh; dry', 'freeze; color'] },
  { id: 1407, unit: '🔭Unit 14', topic: 'Modern Biotechnology', q: 'Cutting and combining DNA from different sources is called:', a: 'Genetic engineering', wrong: ['Photosynthesis', 'Homeostasis', 'Selective breeding only'] },
  { id: 1408, unit: '🔭Unit 14', topic: 'Human Genome Project', q: 'What was the main goal of the Human Genome Project?', a: 'To identify and map all the genes in human DNA', wrong: ['To clone every human', 'To build artificial organs', 'To create the first microscope'] },
  { id: 1409, unit: '🔭Unit 14', topic: 'Human Genome Project', q: 'The Human Genome Project began in ____ and was completed in ____.', a: '1990; 2003', wrong: ['1980; 1990', '1995; 2015', '2001; 2020'] },
  { id: 1410, unit: '🔭Unit 14', topic: 'Human Genome Project', q: 'About what percent of the human genome had been sequenced when the Human Genome Project was completed?', a: 'About 99%', wrong: ['About 25%', 'About 50%', 'About 70%'] },
  { id: 1411, unit: '🔭Unit 14', topic: 'Human Genome Project', q: 'Why is sequencing DNA important?', a: 'It helps scientists find genes, study disease, and compare organisms', wrong: ['It makes DNA grow faster', 'It replaces all proteins in the body', 'It stops all mutations forever'] },
  { id: 1412, unit: '🔭Unit 14', topic: 'Genome Function', q: 'About what percentage of human DNA actually codes for proteins?', a: 'About 2%', wrong: ['About 20%', 'About 50%', 'About 98%'] },
  { id: 1413, unit: '🔭Unit 14', topic: 'Genome Function', q: 'Most of the DNA that does not code for proteins mainly helps with:', a: 'Regulating genes and controlling when they turn on or off', wrong: ['Producing extra bones', 'Storing oxygen for muscles', 'Making only cell walls'] },
  { id: 1414, unit: '🔭Unit 14', topic: 'Genome Function', q: 'If most DNA does not code for proteins, why might it still be important?', a: 'It can control gene activity and help cells know when to use genes', wrong: ['It has no function at all', 'It only exists to fill space', 'It is used only during digestion'] },
  { id: 1415, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'What is epigenetics?', a: 'Changes in gene expression without changing the DNA sequence', wrong: ['Changing every DNA base in a cell', 'Destroying chromosomes during mitosis', 'Making extra copies of proteins'] },
  { id: 1416, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'When ____ groups attach to chromatin, the DNA becomes ____ and cannot be ____.', a: 'methyl; tightly packed; read', wrong: ['phosphate; loose; copied', 'sugar; bright; seen', 'nitrogen; larger; repaired'] },
  { id: 1417, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'The process of adding -CH3 groups to DNA or chromatin is called:', a: 'Methylation', wrong: ['Translation', 'Replication', 'Electrophoresis'] },
  { id: 1418, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'Why is epigenetics important?', a: 'Epigenetic changes can be inherited and can affect traits and health', wrong: ['It only matters in bacteria', 'It changes eye color instantly', 'It replaces natural selection'] },
  { id: 1419, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'How can the environment influence gene expression?', a: 'Diet, stress, and toxins can turn some genes on or off', wrong: ['The environment rewrites every gene permanently', 'Only sunlight can affect genes', 'Environment has no effect on genes'] },
  { id: 1420, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'In the rat study, high-licking and grooming mother rats usually produced offspring that were:', a: 'Calmer and less stressed', wrong: ['More anxious and fearful', 'Unable to grow fur', 'Always identical in behavior'] },
  { id: 1421, unit: '🔭Unit 14', topic: 'Epigenetics', q: 'Tightly packed chromatin is most associated with ____ offspring, while loosely packed chromatin is associated with ____ offspring.', a: 'more stressed; calmer', wrong: ['calmer; more stressed', 'larger; smaller', 'older; younger'] },
  { id: 1422, unit: '🔭Unit 14', topic: 'Restriction Enzymes', q: 'What do bacteria naturally use to cut DNA?', a: 'Restriction enzymes', wrong: ['Ribosomes', 'Antibodies', 'ATP synthase'] },
  { id: 1423, unit: '🔭Unit 14', topic: 'Restriction Enzymes', q: 'Why do bacteria have restriction enzymes?', a: 'To cut up invading viral DNA as a defense', wrong: ['To make glucose from sunlight', 'To build cell membranes', 'To transport oxygen'] },
  { id: 1424, unit: '🔭Unit 14', topic: 'Restriction Enzymes', q: 'How do scientists use restriction enzymes?', a: 'To cut DNA at specific sequences for gene splicing and analysis', wrong: ['To melt DNA into sugar', 'To turn proteins into lipids', 'To stop all mutations'] },
  { id: 1425, unit: '🔭Unit 14', topic: 'Gel Electrophoresis', q: 'What is gel electrophoresis used for?', a: 'Separating DNA fragments by size', wrong: ['Copying DNA', 'Making proteins', 'Cutting chromosomes in half'] },
  { id: 1426, unit: '🔭Unit 14', topic: 'Gel Electrophoresis', q: 'In gel electrophoresis, DNA fragments are loaded into a ____ and an ____ current pulls them through a ____ gel.', a: 'well; electric; agarose', wrong: ['ribosome; magnetic; sugar', 'vacuole; heat; protein', 'nucleus; water; cellulose'] },
  { id: 1427, unit: '🔭Unit 14', topic: 'Gel Electrophoresis', q: 'During gel electrophoresis, small DNA fragments travel ____ and large DNA fragments travel ____.', a: 'farther; less far', wrong: ['less far; farther', 'at the same speed; at the same speed', 'upward only; downward only'] },
  { id: 1428, unit: '🔭Unit 14', topic: 'DNA Fingerprinting', q: 'What is the pattern of bands on a gel often called?', a: 'A DNA fingerprint', wrong: ['A codon chart', 'A karyotype', 'A pedigree'] },
  { id: 1429, unit: '🔭Unit 14', topic: 'DNA Fingerprinting', q: 'What are two common uses of a DNA fingerprint?', a: 'Crime-scene matching and paternity testing', wrong: ['Making ATP and digesting food', 'Measuring blood pressure and pulse', 'Counting chromosomes and making vaccines'] },
  { id: 1430, unit: '🔭Unit 14', topic: 'STRs', q: 'What are STRs?', a: 'Short tandem repeats, which are short DNA sequences repeated many times', wrong: ['Single transfer RNAs', 'Small temporary ribosomes', 'Short translated reactions'] },
  { id: 1431, unit: '🔭Unit 14', topic: 'STRs', q: 'Why are STRs useful?', a: 'They vary from person to person, making them helpful for identification', wrong: ['They are identical in every human', 'They code for all proteins', 'They replace genes during mitosis'] },
  { id: 1432, unit: '🔭Unit 14', topic: 'STRs', q: 'Even though about ____ of human DNA is the same, STRs vary and can be used for ____.', a: '99.9%; identification and family relationships', wrong: ['50%; photosynthesis only', '75%; digestion only', '10%; making ATP'] },
  { id: 1433, unit: '🔭Unit 14', topic: 'DNA Analysis', q: 'What modern technique is commonly used instead of older DNA fingerprinting methods?', a: 'PCR-based STR analysis', wrong: ['Using only microscopes', 'Punnett square analysis', 'Cellular respiration testing'] },
  { id: 1434, unit: '🔭Unit 14', topic: 'PCR', q: 'What problem does PCR solve?', a: 'It makes many copies of a tiny amount of DNA', wrong: ['It turns DNA into proteins', 'It repairs all mutations', 'It separates DNA on a gel'] },
  { id: 1435, unit: '🔭Unit 14', topic: 'PCR', q: 'What does PCR stand for?', a: 'Polymerase chain reaction', wrong: ['Protein coding response', 'Phosphate cell reaction', 'Primary chromosome repair'] },
  { id: 1436, unit: '🔭Unit 14', topic: 'PCR', q: 'PCR is used to make many ____ of DNA.', a: 'copies', wrong: ['mutations', 'proteins', 'chromosomes'] },
  { id: 1437, unit: '🔭Unit 14', topic: 'PCR', q: 'What happens during denaturation in PCR?', a: 'The DNA strands separate when heated', wrong: ['Primers attach to DNA', 'DNA polymerase builds a new strand', 'Proteins fold into shape'] },
  { id: 1438, unit: '🔭Unit 14', topic: 'PCR', q: 'What happens during annealing in PCR?', a: 'Primers bind to the target DNA sequence', wrong: ['DNA melts apart', 'A gel separates DNA', 'RNA leaves the nucleus'] },
  { id: 1439, unit: '🔭Unit 14', topic: 'PCR', q: 'What happens during extension in PCR?', a: 'DNA polymerase adds nucleotides to build new DNA strands', wrong: ['Restriction enzymes cut the DNA', 'The DNA fingerprint is photographed', 'The ribosome reads mRNA'] },
  { id: 1440, unit: '🔭Unit 14', topic: 'PCR', q: 'Why is PCR important in real life?', a: 'It helps with forensics, medical testing, and research', wrong: ['It replaces all body cells', 'It makes food taste sweeter', 'It prevents all diseases'] },
  { id: 1441, unit: '🔭Unit 14', topic: 'Biotechnology Basics', q: 'Which organism is commonly used in early biotechnology to make bread rise?', a: 'Yeast', wrong: ['Oak trees', 'Frogs', 'Mushroom spores only'] },
  { id: 1442, unit: '🔭Unit 14', topic: 'Human Genome Project', q: 'Which is a major benefit of the Human Genome Project?', a: 'Helping scientists find genes linked to diseases', wrong: ['Creating unlimited DNA', 'Stopping inheritance', 'Removing all recessive traits'] },
  { id: 1443, unit: '🔭Unit 14', topic: 'Restriction Enzymes', q: 'Restriction enzymes are sometimes described as molecular ____ because they cut DNA.', a: 'scissors', wrong: ['motors', 'bridges', 'magnets'] },
  { id: 1444, unit: '🔭Unit 14', topic: 'Gel Electrophoresis', q: 'Why do DNA fragments move during gel electrophoresis?', a: 'DNA has a negative charge and is pulled by an electric current', wrong: ['DNA floats because it is full of air', 'DNA moves only because of gravity', 'DNA is pushed by ribosomes'] },
  { id: 1445, unit: '🔭Unit 14', topic: 'PCR', q: 'Which pair lists two real-life uses of PCR?', a: 'Detecting pathogens and analyzing crime-scene DNA', wrong: ['Making ATP and carrying oxygen', 'Building bones and digesting fats', 'Producing chlorophyll and transporting water'] },
