...
const questions = [
  ...
  { id: 1201, unit: 'Unit 12', topic: 'Unit 12', q: 'What is the long name for DNA?', a: 'Deoxyribonucleic acid', wrong: ['Deoxynucleic acid', 'Deoxoribonuclear acid', 'Denatured ribonucleic acid'] },
  { id: 1202, unit: 'Unit 12', topic: 'Unit 12', q: 'Protein function is determined by its', a: 'Structure', wrong: ['Size', 'Composition', 'Location'] },
  { id: 1203, unit: 'Unit 12', topic: 'Unit 12', q: 'What happens in DNA replication?', a: 'Copies of DNA are made', wrong: ['The cell uses information from messenger RNA to make proteins', 'Transfer RNA is made from messenger RNA', 'Messenger RNA is made from DNA'] },
  { id: 1204, unit: 'Unit 12', topic: 'Unit 12', q: 'During DNA replication, a DNA strand that has the bases CTAGGT produces a strand with the bases', a: 'GATCCA', wrong: ['AGCTTG', 'GAUCCA', 'TCGAAC'] },
  { id: 1205, unit: 'Unit 12', topic: 'Unit 12', q: 'The monomers of proteins are (or, proteins are made of)', a: 'Amino acids', wrong: ['Fatty acids', 'Nucleic acids', 'Monosaccharides'] },
  { id: 1206, unit: 'Unit 12', topic: 'Unit 12', q: 'Which of the following is involved in the production of proteins in your body?', a: 'All of the above', wrong: ['tRNA translates a codon sequence into an amino acid sequence', 'tRNA reads the three nucleotide code of mRNA', 'DNA strands separate and a complementary strand of mRNA is formed along one strand of the DNA'] },
  { id: 1207, unit: 'Unit 12', topic: 'Unit 12', q: 'Adenine always pairs with:', a: 'Thymine', wrong: ['Cytosine', 'Guanine', 'Ribose'] },
  { id: 1208, unit: 'Unit 12', topic: 'Unit 12', q: 'How many nucleotides make up a codon?', a: '3', wrong: ['1', '2', '5'] },
  { id: 1209, unit: 'Unit 12', topic: 'Unit 12', q: 'The “rungs” of the DNA ladder are made of:', a: 'Base pairs', wrong: ['Phosphates and hydrogen', 'Glucose and sugars', 'Sugars and phosphates'] },
  { id: 1210, unit: 'Unit 12', topic: 'Unit 12', q: 'What happens in translation?', a: 'The cell uses information from messenger RNA to make proteins', wrong: ['Copies of DNA are made', 'Transfer RNA is made from messenger RNA', 'Messenger RNA is made from DNA'] },
  { id: 1211, unit: 'Unit 12', topic: 'Unit 12', q: 'Which of the following statements is NOT consistent with the structure of DNA?', a: 'Strands are held together by unbreakable chemical bonds', wrong: ['Adenine pairs with thymine and cytosine pairs with guanine', 'Strands are twisted into a double helix', 'DNA is composed of two strands made up of nucleotides'] },
  { id: 1212, unit: 'Unit 12', topic: 'Unit 12', q: 'Which of the following best describes quaternary structure?', a: 'Multiple polypeptide chains forming one protein', wrong: ['Local folding into helices and sheets', 'A chain of amino acids', 'Folding caused by R-group interactions'] },
  { id: 1213, unit: 'Unit 12', topic: 'Unit 12', q: 'A chemical disrupts RNA polymerase activity in a cell. Which process is directly affected?', a: 'Transcription', wrong: ['Protein folding', 'DNA replication', 'Translation'] },
  { id: 1214, unit: 'Unit 12', topic: 'Unit 12', q: 'UV radiation causes damage that prevents DNA from being copied correctly. Which process is most directly impacted first?', a: 'DNA replication', wrong: ['Transcription', 'Translation', 'Protein folding'] },
  { id: 1215, unit: 'Unit 12', topic: 'Unit 12', q: 'Match each scenario to the level of protein structure it BEST represents.', a: 'A. Hemoglobin is made of four polypeptide chains; B. Hydrogen bonds form coils and sheets; C. A mutation changes the order of amino acids in a protein; D. Interactions between R groups create a 3D shape', wrong: [] },
  { id: 1216, unit: 'Unit 12', topic: 'Unit 12', q: 'Proteins are a', a: 'Molecule', wrong: ['Specialized cell', 'Reaction', 'Chemical'] },
  { id: 1217, unit: 'Unit 12', topic: 'Unit 12', q: 'What is the function of DNA in cells?', a: 'It stores the information that directs the ribosomes in protein synthesis', wrong: ['It is a storage area for unused nucleotides', 'It serves as a filler material to keep the nucleus from collapsing', 'It is the storage area for carbohydrates and other macromolecules'] },
  { id: 1218, unit: 'Unit 12', topic: 'Unit 12', q: 'Each new strand of DNA made in replication has how much of the original strand within it?', a: '50%', wrong: ['25%', '0%', '100%'] },
  { id: 1219, unit: 'Unit 12', topic: 'Unit 12', q: 'A segment of DNA which codes for a specific protein is called a', a: 'Gene', wrong: ['Amino acid', 'tRNA', 'Chromosome'] },
  { id: 1220, unit: 'Unit 12', topic: 'Unit 12', q: 'The process by which DNA makes a copy of itself is called:', a: 'Replication', wrong: ['Translation', 'Synthesis', 'Transcription'] },
  { id: 1221, unit: 'Unit 12', topic: 'Unit 12', q: 'DNA replication occurs in the', a: 'Nucleus', wrong: ['Cytoplasm', 'Ribosome', 'Mitochondria'] },
  { id: 1222, unit: 'Unit 12', topic: 'Unit 12', q: 'Protein synthesis (translation) occurs in the', a: 'Ribosome', wrong: ['Cytoplasm', 'Mitochondria', 'Nucleus'] },
  { id: 1223, unit: 'Unit 12', topic: 'Unit 12', q: 'A scientist observes that a protein is shorter than normal because translation stopped early. What most likely caused this?', a: 'Nonsense mutation', wrong: ['Missense mutation', 'Frameshift mutation', 'Silent mutation'] },
  { id: 1224, unit: 'Unit 12', topic: 'Unit 12', q: 'The discovery of the structure of DNA was…', a: 'Watson, Crick, Franklin and Wilkins', wrong: ['Berkely, Fry, Wilkins and Franklin', 'Lamarke, Darwin, and Rosalind Franklin'] },
  { id: 1225, unit: 'Unit 12', topic: 'Unit 12', q: 'Which level of protein structure is directly determined by the DNA sequence?', a: 'Primary', wrong: ['Tertiary', 'Secondary', 'Quaternary'] },
  { id: 1226, unit: 'Unit 12', topic: 'Unit 12', q: 'A mutation changes a DNA base, but the resulting protein is identical to the original. What is the MOST likely explanation?', a: 'The codon still coded for the same amino acid', wrong: ['The gene was not transcribed', 'The mutation caused a frameshift', 'A stop codon was introduced'] },
  { id: 1227, unit: 'Unit 12', topic: 'Unit 12', q: 'A ribosome reads mRNA, but no tRNA molecules can deliver amino acids. What will happen?', a: 'The protein will not be assembled', wrong: ['DNA will be degraded', 'Replication will speed up', 'mRNA will not be produced'] },
  { id: 1228, unit: 'Unit 12', topic: 'Unit 12', q: 'A drug blocks DNA replication, but transcription and translation continue temporarily. What will happen over time?', a: 'Cells cannot divide and will eventually die', wrong: ['Ribosomes will stop functioning immediately', 'Protein production increases permanently', 'Mutations will stop occurring'] },
  { id: 1229, unit: 'Unit 12', topic: 'Unit 12', q: 'Arrange the steps from a gene on DNA to a protein.', a: 'DNA → mRNA → Ribosome → tRNA → Protein', wrong: ['DNA → protein → mRNA → Ribosome', 'mRNA → DNA → tRNA → Protein', 'Protein → tRNA → Ribosome → DNA'] },
  { id: 1230, unit: 'Unit 12', topic: 'Unit 12', q: 'The sugar found in DNA is:', a: 'Deoxyribose', wrong: ['Glucose', 'Equal', 'Ribose'] },
  { id: 1231, unit: 'Unit 12', topic: 'Unit 12', q: 'If a DNA strand had the sequence TACGCATAT, the complementary strand would be:', a: 'ATGCGTATA', wrong: ['TACGCATAT', 'ATATGCGTA', 'AUGCGUAUA', 'None of the above'] },
  { id: 1232, unit: 'Unit 12', topic: 'Unit 12', q: 'Match the terms:', a: 'A. Producing two identical DNA copies; B. Process where proteins are made from RNA; C. Process where RNA is made from DNA', wrong: [] },
  { id: 1233, unit: 'Unit 12', topic: 'Unit 12', q: 'DNA is called the “blueprint of life” because:', a: 'It contains the plans for building an organism', wrong: ['It is like a fingerprint', 'It can relay messages to other molecules', 'It has a blue color'] },
  { id: 1234, unit: 'Unit 12', topic: 'Unit 12', q: 'What happens in transcription?', a: 'Messenger RNA is made from DNA', wrong: ['Copies of DNA are made', 'Transfer RNA is made from messenger RNA', 'The cell uses information from messenger RNA to make proteins'] },
  { id: 1235, unit: 'Unit 12', topic: 'Unit 12', q: 'A cell has the gene for a protein, but the protein is never produced. What is the most likely explanation?', a: 'The gene is not being expressed', wrong: ['The DNA is missing', 'The ribosomes are too fast', 'The codons are incorrect'] },
  { id: 1236, unit: 'Unit 12', topic: 'Unit 12', q: 'Sickle cell anemia is caused by a single base substitution that changes one amino acid in hemoglobin. What type of mutation is this?', a: 'Missense mutation', wrong: ['Silent mutation', 'Frameshift mutation', 'Nonsense mutation'] },
  { id: 1237, unit: 'Unit 12', topic: 'Unit 12', q: 'Which is true?', a: 'Guanine bonds with cytosine', wrong: ['All of the above', 'Guanine bonds with thymine', 'Adenine bonds with cytosine'] },
  { id: 1238, unit: 'Unit 12', topic: 'Unit 12', q: 'A mutation changes one amino acid in a protein, altering its function. What type of mutation is this?', a: 'Missense', wrong: ['Nonsense', 'Frameshift', 'Silent'] },
  { id: 1239, unit: 'Unit 12', topic: 'Unit 12', q: '(Hot spot)', a: 'Tertiary structure', wrong: ['Primary structure', 'Secondary structure', 'Quaternary structure'] },
  { id: 1240, unit: 'Unit 12', topic: 'Unit 12', q: 'The DNA molecule is held together by:', a: 'Hydrogen bonds', wrong: ['Glucose', 'Magnetism', 'Glue'] },
  { id: 1241, unit: 'Unit 12', topic: 'Unit 12', q: 'Why is DNA important?', a: 'It directs the production of proteins within organisms', wrong: ['It is the major component of cytoplasm', 'It directly increases the solubility of nutrients', 'It is a structural component of cell membranes'] },
  { id: 1242, unit: 'Unit 12', topic: 'Unit 12', q: 'A mutation deletes one nucleotide in the middle of a gene. What is the most likely result?', a: 'The entire reading frame shifts', wrong: ['The protein becomes longer', 'Only one amino acid is affected', 'The gene becomes silent'] },
  { id: 1243, unit: 'Unit 12', topic: 'Unit 12', q: 'Using the genetic code chart, determine the amino acids that correspond to the given mRNA codons:', a: 'A. C G C; B. U A U; C. U G A; D. A C U', wrong: [] },
  { id: 1244, unit: 'Unit 12', topic: 'Unit 12', q: 'A gene is:', a: 'A segment of DNA that codes for a protein', wrong: ['A molecule within DNA', 'A set of homologous chromosomes', 'A type of pants'] },
  { id: 1245, unit: 'Unit 12', topic: 'Unit 12', q: 'Which base is never found in DNA?', a: 'Uracil', wrong: ['Adenine', 'Cytosine', 'Thymine', 'Guanine'] },
  { id: 1246, unit: 'Unit 12', topic: 'Unit 12', q: 'Unlike DNA, RNA contains:', a: 'Uracil', wrong: ['Phosphate groups', 'Thymine', 'Adenine'] },
  { id: 1247, unit: 'Unit 12', topic: 'Unit 12', q: 'Why can one amino acid be specified by multiple codons?', a: 'There are 64 codons but only 20 amino acids', wrong: ['Some codons do not specify an amino acid', 'Some codons have the same sequence', 'AUG codes for methionine'] },
  { id: 1248, unit: 'Unit 12', topic: 'Unit 12', q: 'Which contains the codon?', a: 'mRNA', wrong: ['DNA helicase', 'tRNA', 'DNA'] },
  { id: 1249, unit: 'Unit 12', topic: 'Unit 12', q: 'DNA contains the code for:', a: 'Proteins', wrong: ['Lipids', 'Biomolecules', 'Ribosomes'] },
